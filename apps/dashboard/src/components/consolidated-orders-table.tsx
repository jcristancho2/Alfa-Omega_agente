    ...
    <div>
      ...
      <div className="space-y-2 md:hidden">
        {rows.length ? rows.map((row) => {
          const id = text(row.id);
          const canCancel = cancellableStatuses.has(text(row.normalized_status));
